...
search_terms = ["mern developer","Software engineer","Full stack developer","react","ruby on rails","javascript","typescript","Artificial Intelligence","LLM","python","frontend developer","backend engineer","node","mobile developer","vue.js engineer","node developer","mean developer"]
